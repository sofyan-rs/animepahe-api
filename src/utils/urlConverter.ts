...
class UrlConverter {
     ...
     */
    static getMp4Url(m3u8Url: string, kwikDomain: string): string | null {
     ...
     */
    static buildDownloadUrl(m3u8Url: string, kwikDomain: string, metadata: DownloadMetadata): string | null {
